...
export default function Notifications() {
  ...
  const themeStyles = isDark
    ...
    : {
        ...
        statChip: 'border-sky-200 text-slate-600',
        errorCard: 'border-red-200 from-red-50 via-white to-white text-red-900 shadow-red-200',
        retryButton: 'border-sky-200 bg-sky-50/80 text-slate-900 hover:bg-sky-100 focus-visible:ring-sky-400/20',
        emptyCard: 'border-sky-100 from-white via-sky-50 to-sky-100 text-slate-700 shadow-sky-100',
        requestCard: 'border-sky-100 bg-sky-50/80 text-slate-900 shadow-sky-100',
        avatarFrame: 'border-sky-100 from-sky-100 to-sky-200 shadow-sky-100',
        avatarLetter: 'text-sky-900',
        detailLabel: 'text-slate-500',
        ...
        secondaryButton: 'border-sky-200 text-slate-900 hover:bg-sky-100 disabled:cursor-not-allowed disabled:opacity-50',
        loadingPanel: 'border-sky-100 bg-gradient-to-br from-white via-sky-50 to-sky-100 text-slate-900 shadow-sky-100',
        loadingStatus: 'border-sky-100 bg-sky-50 text-slate-600',
        loadingDot: 'bg-sky-500',
      }
